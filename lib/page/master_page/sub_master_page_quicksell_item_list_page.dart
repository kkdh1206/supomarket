...
class SubMasterPageQuickSellItemListPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SubMasterPageQuickSellItemListPageState();
  }
}

class _SubMasterPageQuickSellItemListPageState extends State<SubMasterPageQuickSellItemListPage> {
  ...
  @override
  void initState() {
    debugPrint("Quick Sell Initiate");
    super.initState();
    onePageUpdateList();
    ...
    try {
      ...
      if (jsonData.toString() != "true") {
        ...
        for (var data in jsonData) {
          ...
          debugPrint(itemList[0].sellingTitle.toString());
        }
